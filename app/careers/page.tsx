    ...
    <>
      <section className="bg-[#f0f9fc] py-14 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold text-[#1a3a4a] mb-4">Join Our Team</h1>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-[#1a3a4a] mb-4">Why Work at Coastal?</h2>
          <p className="text-[#4a6b7a] leading-relaxed mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-12">
            {values.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white border border-[#d1e8ee] rounded-2xl p-6">
                <div className="w-10 h-10 rounded-full bg-[#f0f9fc] flex items-center justify-center mb-4">
                  <Icon size={20} className="text-[#1a9cb5]" />
                </div>
          ...
          {/* Open positions */}
          <div className="bg-[#f0f9fc] border border-[#d1e8ee] rounded-2xl p-8 text-center">
            <Briefcase size={36} className="text-gray-300 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-[#1a3a4a] mb-2">No Open Positions Right Now</h3>
            <p className="text-[#4a6b7a] text-sm max-w-md mx-auto mb-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#1a9cb5] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#147a8f] transition"
            >
              <Mail size={16} />
              Send Your Resume
            </a>
