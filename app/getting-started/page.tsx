    ...
    <>
      ...
      <section className="bg-[#f0f9fc] py-14 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold text-[#1a3a4a] mb-4">Getting Started</h1>
      ...
      {active === 0 && (
        <section className="py-14 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-[#1a3a4a] text-center mb-10 gold-underline">How It Works</h2>
            <div className="space-y-6 mt-10">
              {steps.map(({ number, title, desc }) => (
                <div key={title} className="relative flex gap-6 items-start bg-white border border-[#d1e8ee] rounded-2xl p-6 overflow-hidden">
                  {/* Decorative large number */}
                  <span className="absolute right-4 top-1/2 -translate-y-1/2 text-7xl font-black text-[#d1e8ee] select-none pointer-events-none leading-none">
                    {number}
                  </span>
            ...
            <div className="text-center mt-10">
              <button
                onClick={openModal}
                className="bg-[#1a9cb5] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#147a8f] transition inline-flex items-center gap-2"
              >
      ...
      {active === 1 && (
        <section className="py-14 px-4 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-[#1a3a4a] mb-6">What to Expect at the Evaluation</h2>
            <p className="text-[#4a6b7a] leading-relaxed mb-4">
            ...
            <p className="text-[#4a6b7a] leading-relaxed mb-6">
            ...
            <div className="bg-[#f0f9fc] border border-[#d1e8ee] rounded-2xl p-6 mb-8">
              <h3 className="font-bold text-[#1a3a4a] mb-4">What the Evaluation Includes</h3>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-sm text-[#4a6b7a]">
                    <span className="text-[#dba843] shrink-0 mt-0.5">▪</span>
                    {item}
                  </li>
                ))}
              </ul>
      ...
      {active === 2 && (
        <section className="py-14 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-[#1a3a4a] mb-8">Scheduling & Hours</h2>

            {/* Hours */}
            <div className="bg-[#f0f9fc] border border-[#d1e8ee] rounded-2xl p-6 mb-8">
              <h3 className="font-bold text-[#1a3a4a] text-lg mb-4">Office Hours</h3>
              <div className="grid sm:grid-cols-2 gap-4 text-sm text-[#4a6b7a]">
                <div className="flex justify-between border-b border-[#d1e8ee] pb-2">
                  <span className="font-medium text-[#1a3a4a]">Monday – Friday</span>
                  <span>8:30 AM – 5:30 PM</span>
                </div>
              </div>
              <p className="text-xs text-[#4a6b7a] mt-3">
                * Hours may vary by location or therapist. Contact us to confirm availability.
              </p>
            </div>

            {/* Settings */}
            <h3 className="font-bold text-[#1a3a4a] text-lg mb-4">Available Therapy Settings</h3>
            <div className="grid md:grid-cols-3 gap-5 mb-8">
              {settings.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="bg-white border border-[#d1e8ee] rounded-2xl p-5">
                  <Icon size={20} className="text-[#1a9cb5] mb-3" />
                  <h4 className="font-bold text-[#1a3a4a] mb-2">{title}</h4>
                  <p className="text-sm text-[#4a6b7a] leading-relaxed">{desc}</p>
                </div>
              ))}
            </div>

            {/* Locations */}
            <h3 className="font-bold text-[#1a3a4a] text-lg mb-4">Our Locations</h3>
            <div className="grid md:grid-cols-2 gap-5 mb-8">
              <div className="bg-[#f0f9fc] border border-[#d1e8ee] rounded-2xl p-5">
                <h4 className="font-bold text-[#1a3a4a] mb-2">Jacksonville Beach</h4>
                <p className="text-sm text-[#4a6b7a]">2730 Isabella Blvd, Suite 10<br />Jacksonville Beach, FL 32250</p>
                <a
                  href="https://maps.google.com/?q=2730+Isabella+Blvd+Suite+10+Jacksonville+Beach+FL+32250"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 mt-3 text-sm text-[#1a9cb5] font-semibold hover:underline"
                >
                  Get Directions <ArrowRight size={14} />
                </a>
              </div>
              <div className="bg-[#f0f9fc] border border-[#d1e8ee] rounded-2xl p-5">
                <h4 className="font-bold text-[#1a3a4a] mb-2">Mandarin</h4>
                <p className="text-sm text-[#4a6b7a]">6100 Greenland Rd, Suite 901<br />Jacksonville, FL 32258</p>
                <a
