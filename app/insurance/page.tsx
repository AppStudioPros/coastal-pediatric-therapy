        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <ul className="space-y-3">
              {plans.map((plan) => (
                <li key={plan} className="flex items-center gap-3 bg-[#eaf7f9] border border-[#cce8ef] rounded-lg px-4 py-3 text-[#4a7a8a]">
                  <ShieldCheck size={18} className="text-[#2fb8c6] shrink-0" />
                  {plan}
                </li>
              ))}
            </ul>
          ...
          <div className="space-y-6">
            <div className="bg-[#eaf7f9] rounded-xl p-6">
            ...
            <div className="bg-white border border-[#cce8ef] rounded-xl p-6">
              ...
              <a href="tel:9043724070" className="bg-[#2fb8c6] text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-[#2aa8b8] transition text-sm inline-block">
                Call (904) 372-4070
              </a>
            </div>
            <div className="bg-white border border-[#cce8ef] rounded-xl p-6">
