      ...
      <section className="bg-white py-20 md:py-28 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-lg">
            <p className="text-[#F5C518] font-semibold text-sm uppercase tracking-widest mb-4">
            ...
            {testimonials.map(({ quote, name }) => (
              <div key={name} className="bg-[#EAF6FB] rounded-2xl p-8">
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => <Star key={i} size={16} className="fill-[#F5C518] text-[#F5C518]" />)}
                </div>
      ...
      <section className="py-20 px-4 bg-[#1e3a4a] text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={openModal}
              className="bg-[#F5C518] text-[#1e3a4a] font-bold px-8 py-3 rounded-lg hover:bg-[#E0B210] transition"
            >
              Book an Appointment
            </button>
