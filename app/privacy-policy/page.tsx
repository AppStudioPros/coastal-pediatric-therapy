      ...
      <section className="bg-[#e8f4f9] py-14 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            <Shield size={32} className="text-[#1e7faa]" />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose prose-gray max-w-none">
          <div className="space-y-10 text-gray-700 leading-relaxed">
            ...
            {/* HIPAA Notice */}
            <div id="hipaa">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">HIPAA Notice of Privacy Practices</h2>
              <p>
            ...
            {/* COPPA */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Children&apos;s Privacy (COPPA)</h2>
              <p>
            ...
            {/* FL Telehealth */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Florida Telehealth Disclosure</h2>
              <p>
            ...
            {/* Good Faith Estimate */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Good Faith Estimate (No Surprises Act)</h2>
              <p>
            ...
            <div>
              ...
              <div className="mt-3 bg-[#e8f4f9] rounded-xl p-4 text-sm">
                <p className="font-semibold text-gray-900">Coastal Pediatric Therapy Center</p>
