      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="space-y-10 text-[#4a7a8a] leading-relaxed">
            ...
            {/* Acceptance */}
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">Acceptance of Terms</h2>
              <p>
            ...
            {/* Website Use */}
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">Website Use — Not Medical Advice</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">No Patient-Provider Relationship</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">Appointment Policies</h2>
              <p>
            ...
            {/* Online Payment */}
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">Online Payment</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">Intellectual Property</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">Limitation of Liability</h2>
              <p>
            ...
            {/* Governing Law */}
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a4a] mb-3">Governing Law</h2>
              <p>
