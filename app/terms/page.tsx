      ...
      <section className="bg-[#e8f4f9] py-14 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            <FileText size={32} className="text-[#1e7faa]" />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="space-y-10 text-gray-700 leading-relaxed">
            ...
            {/* Website Use */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Website Use — Not Medical Advice</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">No Patient-Provider Relationship</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Appointment Policies</h2>
              <p>
            ...
            {/* Online Payment */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Online Payment</h2>
              <p>
