  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white border border-[#B8E4F0] rounded-2xl p-8 space-y-5">
      ...
      <button
        ...
        className="cta-blue-3 w-full bg-[#24B5D0] text-white py-3 rounded-lg font-semibold hover:bg-[#1A9EC0] transition text-sm flex items-center justify-center gap-2 disabled:opacity-60"
      >
